    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <li class="@if(\Request::route()->getName() == 'listAd') active @endif">
                    <a href="{{route('listAd')}}"><i class="fa fa-fw fa-desktop"></i> Ads</a>
                </li>
                <li class="@if(\Request::route()->getName() == 'listCategory') active @endif">
                    <a href="{{route('listCategory')}}"><i class="fa fa-fw fa-list"></i> Categories</a>
                </li>
                <li class="@if(\Request::route()->getName() == 'listTag') active @endif">
                    <a href="{{route('listTag')}}"><i class="fa fa-fw fa-tags"></i> Tags</a>
                </li>
